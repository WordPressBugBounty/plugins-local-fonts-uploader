...
View all features [Visit the Official Site](https://localfonts.themeruby.com/)
...
## Documentation
Access the plugin documentation for usage instructions: [Documentation](https://localfonts.themeruby.com/docs/)
...
2. Assigning font to selector
3. Create a New Font
4. Upload Font Variants
5. Assign Font Variant to CSS Selector
...
If you want to contribute, go to our [GitHub Repository](https://github.com/ThemeRuby/local-fonts-uploader) and see where you can help.
...
* Improved: Updated documentation page.

= 1.1.0 =

* Improved: FILTER_SANITIZE_STRING is deprecated.
